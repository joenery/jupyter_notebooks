...
def plot_reads_vs_sampleID_reversed(demux_stats):
    """
    Generates a plot with reversed axes: SampleID on the y-axis and # reads on the x-axis, for each Lane.
    ...
    pivot_table.plot(kind='barh', figsize=(10, 6))  # 'barh' for horizontal bars
...
if __name__ == "__main__":
    ...
    plot_reads_vs_sampleID_reversed(demux_stats)
